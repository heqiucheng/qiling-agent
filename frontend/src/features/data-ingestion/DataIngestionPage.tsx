      ...
      <div className="page-grid page-grid--two">
        ...
        <Card className="form-panel">
          <div>
            ...
            <p className="state-panel__message">MVP 优先支持粘贴文本，确认后会生成客户画像和待确认话术任务。</p>
          </div>
          ...
          <div className="task-card__actions">
            <Button variant="primary" onClick={handleUpload} disabled={isSubmitting}>上传解析</Button>
            <Button variant="secondary" onClick={handleConfirm} disabled={!uploadResult || isSubmitting}>确认并生成任务</Button>
          </div>
